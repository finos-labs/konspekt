# Konspekt Contribution and Governance Policies

This document describes the contribution process and governance policies of the FINOS Konspekt project.
...
Konspekt is [Apache 2.0 licensed](https://www.apache.org/licenses/LICENSE-2.0) and accepts contributions via Git pull requests.

## Technical Charter

A **Technical Charter** for the Konspekt project is published as a (**PDF at the root of this repository**)[./technical-charter.pdf]. That charter defines the project's mission, scope, TSC structure, IP and licensing, and related governance.
...
* If necessary, such as due to third-party dependency licensing requirements, update the [NOTICE file](https://github.com/finos-labs/Konspekt/blob/master/NOTICE) with any new attribution or other notices.
