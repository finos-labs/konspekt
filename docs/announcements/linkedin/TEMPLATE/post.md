...
assets:                   # what went in the post; omit if text-only
  - file: images/NAME.png       # image as published, local to this post dir
    source: docs/visuals/...    # repo path it was rendered from (optional)
    alt: short description
---

<post text exactly as it will be published>
