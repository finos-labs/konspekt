...
| e-drv-humandisp-uiaccept | drives | concept:concept-ui-human-disposition | waypoint:wp-adr-ui-accept-action |  | proposed |
| e-mark-uiaccept-uitask | marks | waypoint:wp-adr-ui-accept-action | node:task-ui-simple-actions |  | proposed |
| e-dec-usability-uiactions | decomposes | node:goal-usability | node:task-ui-simple-actions |  | proposed |
